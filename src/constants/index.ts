export const errors = {
    en: {
        ...
        "WrongOldPassword":"Old Password is incorrect Please fill Correct Password ",
        ...
        "accountUnverified": "Your Account is unverified due to phoneNumber update, please contact Vendor",
